...
public partial class module: jpage
{
  ...
  private string Module_Action_Add()
  {
    ...
    tsqlstr += account.getUserID(request.form("auusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("auusername")), 50) + "',";
    tsqlstr += account.getUserID(request.form("ruusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("ruusername")), 50) + "',";
  ...
  private string Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "auid") + "=" + account.getUserID(request.form("auusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "auusername") + "='" + cls.getLeft(encode.addslashes(request.form("auusername")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "ruid") + "=" + account.getUserID(request.form("ruusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "ruusername") + "='" + cls.getLeft(encode.addslashes(request.form("ruusername")), 50) + "',";
