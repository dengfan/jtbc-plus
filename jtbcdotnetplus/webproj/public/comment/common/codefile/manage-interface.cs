...
public partial class module: jpage
{
  ...
  private string Module_Action_Add()
  {
    ...
    tsqlstr += ") values (";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("muusername")), 50) + "',";
    tsqlstr += account.getUserID(request.form("muusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("ip")), 50) + "',";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("content")), 10000) + "',";
  ...
  private string Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "muusername") + "='" + cls.getLeft(encode.addslashes(request.form("muusername")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "muid") + "=" + account.getUserID(request.form("muusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "ip") + "='" + cls.getLeft(encode.addslashes(request.form("ip")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "content") + "='" + cls.getLeft(encode.addslashes(request.form("content")), 10000) + "',";
    tsqlstr += cls.cfnames(tfpre, "keyword") + "='" + cls.getLeft(encode.addslashes(request.form("keyword")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "fid") + "=" + cls.getNum(request.form("fid"), 0) + ",";
  ...
  private string Module_List()
  {
    ...
    if (tfield == "username") tsqlstr += " and " + cls.cfnames(tfpre, "muusername") + " like '%" + tkeyword + "%'";
