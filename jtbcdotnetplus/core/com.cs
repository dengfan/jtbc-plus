namespace jtbc
{
    ...
    public static class com
    {
        ...
        public static string isort(string argStrings)
        {
            ...
            {
                argTemplate = argTemplate.Replace(config.jtbccinfo, str3);
            }
            ...
            if (strArray4 != null)
            {
                ...
                for (num = 0; num < strArray4.GetLength(0); num++)
                {
                    ...
                    if (cls.isEmpty(str8) || cls.cinstr(str8, argStr, ","))
                    {
                        num2++;
                        string str4 = str2;
                        str4 = str4.Replace("{$namestring}", argStr).Replace("{$valuestring}", str19).Replace("{$name}", encode.htmlencode(argStr)).Replace("{$value}", encode.htmlencode(str19)).Replace("{$-genre}", str12).Replace("{$-baseurl}", str14).Replace("{$-i}", cls.toString(num2));
                        for (int i = 2; i < 7; i++)
                        {
                            int num4 = num2 % i;
