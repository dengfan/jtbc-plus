...
public partial class module: jpage
{
  ...
  private string Module_Action_Add()
  {
    ...
    tsqlstr += account.getUserID(request.form("fuusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("fuusername")), 50) + "',";
    tsqlstr += "'" + cls.getDate() + "'";
    tsqlstr += ")";
  ...
  private string Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "fuid") + "=" + account.getUserID(request.form("fuusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "fuusername") + "='" + cls.getLeft(encode.addslashes(request.form("fuusername")), 50) + "',";
