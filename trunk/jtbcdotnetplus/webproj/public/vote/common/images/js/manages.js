...
manages.options = {
  ...
  tAdds: function(_strers)
  {
    ...
    if (manage.tckBackString(tstrers))
    {
      $('optionsListFactory').innerHTML = tstrers;
      var tnewoptionsObj = $('optionsListFactory').getElementsByTagName('table')[0];
      if (tnewoptionsObj) $('optionsList').appendChild(tnewoptionsObj);
    };
  },
  ...
  tEdits: function(_strers)
  {
    ...
    if (manage.tckBackString(tstrers))
    {
      ...
      $('optionsnum').value = tAry.length;
      $('optionsList').innerHTML = tstrers;
    };
  },
  tDelete: function(_id)
  {
    var tid = _id;
    var tobj = $('options-' + tid);
