...
public partial class module: jpage
{
  ...
  private string Module_Action_Add()
  {
    ...
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("snum")), 50) + "',";
    tsqlstr += cls.getNum(request.form("class"), 0) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(request.form("image")), 255) + "',";
    tsqlstr += cls.getDouble(request.form("yprice"), 0).ToString("F2") + ",";
    tsqlstr += cls.getDouble(request.form("xprice"), 0).ToString("F2") + ",";
    tsqlstr += cls.getNum(request.form("amount"), 0) + ",";
  ...
  private string Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "snum") + "='" + cls.getLeft(encode.addslashes(request.form("snum")), 50) + "',";
    ...
    tsqlstr += cls.cfnames(tfpre, "yprice") + "=" + cls.getDouble(request.form("yprice"), 0).ToString("F2") + ",";
    tsqlstr += cls.cfnames(tfpre, "xprice") + "=" + cls.getDouble(request.form("xprice"), 0).ToString("F2") + ",";
    tsqlstr += cls.cfnames(tfpre, "amount") + "=" + cls.getNum(request.form("amount"), 0) + ",";
  ...
  private string Module_List()
  {
    ...
    if (tfield == "snum") tsqlstr += " and " + cls.cfnames(tfpre, "snum") + " like '%" + tkeyword + "%'";
